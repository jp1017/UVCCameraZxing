...
import com.serenegiant.event.BitmapEvent;
...
public class CameraFragment extends Fragment implements BitmapEvent{
...
//				mCameraClient.removeSurface(mCameraViewSub.getHolder().getSurface());
	...
	public void postBitmap(Bitmap bitmap) {
		Log.w(TAG, "getBitmap from eventbus");
	}

	@Override
	@Subscribe
	public void setBitmap(Bitmap bitmap) {
		Log.w(TAG, "getBitmap from router");
	}
}
